            ...
            <section className='bg-neutral-100 dark:bg-neutral-900 shadow-md'>
                <div class="grid grid-cols-card gap-2 items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5">
                    <div class="w-full max-w-sm bg-white rounded-lg shadow-sm hover:shadow-2xl dark:bg-neutral-800 dark:border-neutral-700">
                        ...
                        <div class="px-5 pb-5">
                            <a href="#">
                                <h5 class="text-lg font-medium tracking-tight text-neutral-900 dark:text-white">Apple Watch Series 7 GPS, Aluminium Case, Starlight Sport</h5>
                            </a>
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-lg font-bold text-neutral-900 dark:text-white">$599</span>
